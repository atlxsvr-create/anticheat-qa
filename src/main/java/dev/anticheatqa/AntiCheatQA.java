...
public class AntiCheatQA implements ClientModInitializer {
    public static final String MOD_ID = "clientcraft";
    ...
    public void onInitializeClient() {
        INSTANCE = this;
        LOGGER.info("ClientCraft initializing (1.21.11)");
        ...
        LOGGER.info("ClientCraft ready. Press Right Shift to open ClickGUI.");
    }
